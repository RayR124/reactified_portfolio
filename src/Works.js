                ...
                <ul style={{ color: 'white', marginBottom: 20 }}
                    ...
                    {showTK && (
                        <li style={{ color: 'white', marginBottom: 20 }}>
                            ...
                            UC Berkeley Extension. Our group members were myself, {' '} <a style={{ color: 'white' }} href="https://github.com/isayahdurst">Isayah Durst</a>, {' '} <a style={{ color: 'white' }} href="https://github.com/frankmng">Frank Nguyen</a>, {' '} <a style={{ color: 'white' }} href="https://github.com/lunchtimewhee">Anthony Li</a>, and {' '}<a style={{ color: 'white' }} href="https://github.com/Ahneb">Benjamin Ha</a>. It is a meal planning application wherein you can create a meal plan that's tailored to your specific diet preferences. Taylor's Kitchen allows you to customize your diets, cuisines, and food intolerances to your liking to recommend foods and recipes that compliment your tastes and needs. Taylor's Kitchen was built using two different server-side APIs and is a complete front-end solution. Without having access to a back-end, we've leveraged local-storage and third-party data storage solutions to bring this project to life and create something that we found to be challenging, exciting, and useful. You can click the image below to be taken directly to the deployed site and check it out!
                        </li>
                    )}
                </ul>
